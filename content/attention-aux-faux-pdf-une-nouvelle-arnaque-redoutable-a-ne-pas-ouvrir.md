...
Oubliez les anciens courriels de faux héritages ou les fautes d’orthographe grossières. Les cybercriminels ont changé de méthode. Désormais, **les arnaques par fichiers PDF se multiplient** et prennent des allures de documents officiels, souvent très convaincants. Cette nouvelle méthode est connue sous le nom de **TOAD ([Telephone-Oriented Attack Delivery](https://www.proofpoint.com/fr/blog/email-and-cloud-threats/actionable-insights-reduce-your-organizations-risk-toad-attack))**.
