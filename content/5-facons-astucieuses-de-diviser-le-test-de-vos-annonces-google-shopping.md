---
title: "5 façons astucieuses de diviser le test de vos annonces Google Shopping"
permalink: "/5-facons-astucieuses-de-diviser-le-test-de-vos-annonces-google-shopping/"
date: "2022-07-21T12:53:19+00:00"
...
description: "L'un des meilleurs moyens d'augmenter votre rentabilité ?  Tests fractionnés A/B.  Google Ads propose une fonctionnalité appelée Tests dans laquelle vous po"
cover: "https://leconceptmarketing.com/wp-content/uploads/2022/07/google-shopping-split-test-social.png"
source_capture: "20220812173750"
---
...
-   [1 Comment tester A/B les informations produit](#Comment_tester_AB_les_informations_produit)
    -   [1.1 1. La méthode d’analyse par grappes](#1_La_methode_d8217analyse_par_grappes)
    -   [1.2 2. La méthode du partage aléatoire](#2_La_methode_du_partage_aleatoire)
-   [2 Comment tester les paramètres de campagne A/B](#Comment_tester_les_parametres_de_campagne_AB)
    -   [2.1 3. La méthode de fractionnement de Customer Match](#3_La_methode_de_fractionnement_de_Customer_Match)
        -   [2.1.1 Comment faire](#Comment_faire)
        -   [2.1.2 Avantages](#Avantages)
        -   [2.1.3 Les inconvénients](#Les_inconvenients)
    -   [2.2 4. La méthode de test géo-split](#4_La_methode_de_test_geo-split)
        -   [2.2.1 Comment faire](#Comment_faire-2)
        -   [2.2.2 Avantages](#Avantages-2)
        -   [2.2.3 Les inconvénients](#Les_inconvenients-2)
    -   [2.3 5. La méthode de fractionnement de campagne](#5_La_methode_de_fractionnement_de_campagne)
        -   [2.3.1 Comment faire](#Comment_faire-3)
        -   [2.3.2 Avantages](#Avantages-3)
        -   [2.3.3 Les inconvénients](#Les_inconvenients-3)
-   [3 Dernières pensées](#Dernieres_pensees)
...
![google shopping copie de produit de test ab](https://leconceptmarketing.com/wp-content/uploads/2022/07/1658407999_832_5-facons-astucieuses-de-diviser-le-test-de-vos-annonces.png)
...
![google shopping a/b testing - configuration du test de titre](https://leconceptmarketing.com/wp-content/uploads/2022/07/1658407999_333_5-facons-astucieuses-de-diviser-le-test-de-vos-annonces.png)
...
![Configuration de la correspondance client Google Ads](https://leconceptmarketing.com/wp-content/uploads/2022/07/5-facons-astucieuses-de-diviser-le-test-de-vos-annonces.webp.webp)

_[Source des images](https://www.datafeedwatch.com/blog/attract-past-buyers-customer-match-google-shopping-campaigns)_
...
![test a/b de google shopping - configuration de l'expérience géographique](https://leconceptmarketing.com/wp-content/uploads/2022/07/1658407999_183_5-facons-astucieuses-de-diviser-le-test-de-vos-annonces.png)
...
![options d'enchères de google shopping](https://leconceptmarketing.com/wp-content/uploads/2022/07/1658407999_760_5-facons-astucieuses-de-diviser-le-test-de-vos-annonces.png)

_Le budget et la stratégie d’enchères sont deux paramètres que vous pouvez tester._
...
-   Moins fiable : la saisonnalité peut jouer un rôle dans différentes campagnes, en particulier si vos campagnes sont divisées par catégorie de produits (avez-vous essayé la [structure de campagne d’enchères prioritaires ?).](https://www.wordstream.com/blog/ws/2021/08/25/google-shopping-ads-priority-bidding-structure)
-   [La préparation peut être difficile : l’analyse de clusters sur des groupes de campagnes peut être difficile lorsqu’il s’agit de petits ensembles de campagnes et de données.](https://www.wordstream.com/blog/ws/2021/08/25/google-shopping-ads-priority-bidding-structure)

## [Dernières pensées](https://www.wordstream.com/blog/ws/2021/08/25/google-shopping-ads-priority-bidding-structure)

[C’est ça! Cinq façons différentes d’exécuter des tests A/B pour vos annonces Google Shopping :](https://www.wordstream.com/blog/ws/2021/08/25/google-shopping-ads-priority-bidding-structure)

1.  [Testez les attributs de flux de produits en créant des groupes avec une analyse de cluster.](https://www.wordstream.com/blog/ws/2021/08/25/google-shopping-ads-priority-bidding-structure)
2.  [Testez les attributs du flux de produits en créant des groupes avec une répartition aléatoire.](https://www.wordstream.com/blog/ws/2021/08/25/google-shopping-ads-priority-bidding-structure)
3.  [Testez les paramètres de campagne avec les groupes de ciblage par liste de clients.](https://www.wordstream.com/blog/ws/2021/08/25/google-shopping-ads-priority-bidding-structure)
4.  [Testez les paramètres de campagne avec les géos.](https://www.wordstream.com/blog/ws/2021/08/25/google-shopping-ads-priority-bidding-structure)
5.  [Tester les paramètres de campagne avec des groupes de campagne](https://www.wordstream.com/blog/ws/2021/08/25/google-shopping-ads-priority-bidding-structure)

[La qualité du résultat dépend de la qualité de votre analyse préliminaire (cluster) et de votre configuration. Ce que vous obtenez est ce que vous y mettez. J’espère que cela vous aidera à optimiser vos campagnes Google Shopping. Si vous essayez l’une de ces méthodes, partagez les résultats dans les commentaires ! Pour l’instant, passez une merveilleuse journée et continuez à optimiser !](https://www.wordstream.com/blog/ws/2021/08/25/google-shopping-ads-priority-bidding-structure)