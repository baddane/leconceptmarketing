---
title: "10 conseils WordPress pour sécuriser votre site web"
permalink: "/10-conseils-wordpress-pour-securiser-votre-site-web/"
legacy_permalinks: []
type: "post"
date: "2022-01-10T18:30:00+00:00"
modified: ""
author: "Sébastian Magni @ Responsable du contenu"
categories: ["Thèmes","WordPress"]
tags: ["conseils WordPress","sécuriser site wordpress","sécuriser son site wordpress","sécuriser un site wordpress","sécuriser votre site web","sécuriser wordpress","securiser wordpress","sécurité wordpress","wordpress","wordpress sécurité"]
description: "WordPress est le système de gestion de contenu (CMS) le plus populaire et alimente plus de 30 % des sites web. Cependant, à mesure qu'il se développe, les pi"
cover: "https://leconceptmarketing.com/wp-content/uploads/2022/01/sc.png"
source_url: "https://leconceptmarketing.com/10-conseils-wordpress-pour-securiser-votre-site-web/"
source_capture: "20220129010816"
---
WordPress est [le système de gestion de contenu](https://leconceptmarketing.com/quest-ce-que-cest-systeme-de-gestion-de-contenu-cms/) (CMS) le plus populaire et alimente plus de 30 % des sites web. Cependant, à mesure qu’il se développe, les pirates informatiques en ont pris note et commencent à cibler spécifiquement les sites WordPress.

![10 conseils WordPress pour sécuriser votre site web](https://bitwaretechnologies.com/wp-content/uploads/2017/03/Complete-Wordpress-Security.png)
...
- 1 1. Choisissez un bon hébergeur
- 2 2. N’utilisez pas de thèmes nuls :
- 3 3. Installez un plugin de sécurité WordPress
- 4 4. Utilisez un mot de passe fort
- 5 5. Désactiver l’édition de fichiers
- 6 6. Installer un certificat SSL
- 7 7. Modifiez votre URL de connexion à WP
- 8 8. Limiter les tentatives de connexion
- 9 9. Masquer les fichiers wp-config.php et .htaccess
- 10 10. Mettez à jour votre version de WordPress
- 11 Conclusion
...
Bien qu’il existe de nombreuses sociétés d’hébergement, nous recommandons **[DigitalOcean](https://m.do.co/c/175cbee2923f)**.**[HostGator ](http://partners.hostgator.com/vqDBA)**ou **[Bluehost](http://bluehost.sjv.io/mgoa2X)**.
...
**Lecture complémentaire** : **[Divi WordPress : Est-il un des meilleurs thèmes ? Test et verdict !](https://leconceptmarketing.com/divi-wordpress-est-il-un-des-meilleurs-themes-test-et-verdict/)**
...
![Désactiver l'édition de fichiers  wordpress](https://miro.medium.com/max/470/0*YTCPTDzsE_ag6LvV.png)
...
Vous pouvez activer cette fonction facilement avec [le plugin WordPress login limit attempts.](https://wordpress.org/plugins/limit-login-attempts-reloaded/) Après avoir installé le plugin, vous pouvez modifier le nombre de tentatives de connexion via Paramètres> Tentatives de connexion limitées. Si vous souhaitez activer les tentatives de connexion sans plugin, vous pouvez également le faire. Le tutoriel complet est ici.

![10 conseils WordPress pour sécuriser votre site web](https://miro.medium.com/max/454/0*a5d6LyH_cOB2UiMg.png)

**Lecture complémentaire** :[ **10+ Meilleurs thèmes WordPress pour les cabinets de conseil et de consulting**](https://leconceptmarketing.com/10-meilleurs-themes-wordpress-pour-les-cabinets-de-conseil-et-de-consulting/)
