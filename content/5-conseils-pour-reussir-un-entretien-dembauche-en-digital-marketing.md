...
![](https://leconceptmarketing.com/wp-content/uploads/2021/11/entre.jpg)
...
L’espace du marketing digital est varié, allant du SEO, plan [stratégique du digital](https://leconceptmarketing.com/comment-creer-un-plan-de-strategie-de-marketing-digital-efficace/), [l’inbound marketing](https://leconceptmarketing.com/%e2%96%b7-comment-generer-des-leads-qualifies-avec-linbound-marketing/), les problématiques du [trafic](https://leconceptmarketing.com/comment-attirer-du-trafic-vers-son-site-web-15-techniques-attrayantes/), [le marketing des réseaux sociaux](https://leconceptmarketing.com/comment-faire-connaitre-son-entreprise-sur-les-reseaux-sociaux-en-10-etapes/) en passant par l’automatisation du marketing.
...
Par exemple, si le [référencemen](https://leconceptmarketing.com/comment-optimiser-votre-site-web-pour-le-referencement-et-les-conversions/)t n’est pas votre point fort mais que le candidat retenu devra y travailler, dites quelque chose comme : “Bien que mes fonctions précédentes ne m’aient pas permis d’acquérir beaucoup d’expérience en matière de référencement, j’ai pris l’habitude de me tenir au courant grâce aux blogs et aux podcasts sur le référencement”. L’interviewer appréciera votre honnêteté et votre initiative pour en savoir plus sur le sujet.

## Limitez au maximum le jargon et les mots de tendance

S’il peut être tentant de dire tout ce que vous savez sur le growth hacking, les [hashtags](https://leconceptmarketing.com/quest-ce-quun-hashtag-comment-les-utiliser-pour-votre-petite-entreprise/) et la gamification, vous perdrez rapidement l’intérêt de votre interlocuteur si aucun de ces termes n’a de rapport avec le poste pour lequel vous passez l’entretien.
...
Si vous n’avez pas eu l’occasion de travailler avec des outils d’analyse dans votre expérience professionnelle, essayez d’y être exposé autant que possible en dehors du travail. Créez un [blog](https://leconceptmarketing.com/%e2%96%b7-comment-creer-un-blog-rentable-qui-rapporte-a-partir-de-zero-en-2021/) et installez Google Analytics. Connectez-vous à votre compte Twitter et vérifiez les statistiques de vos tweets. Il existe d’innombrables ressources en ligne pour vous aider à vous familiariser avec [Google Analytics](https://analytics.google.com/analytics/web/provision/#/provision).
